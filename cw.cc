...
ofstream outfile ("scratch/RLinWiFi-Decentralized-v14-30-station/CW_data.csv", fstream::out);
/*ofstream outfile1 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_1_data.csv", ios::app);
ofstream outfile2 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_2_data.csv", ios::app);
ofstream outfile3 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_3_data.csv", ios::app);
ofstream outfile4 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_4_data.csv", ios::app);
ofstream outfile5 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_5_data.csv", ios::app);

ofstream outfile6 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_6_data.csv", ios::app);
ofstream outfile7 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_7_data.csv", ios::app);
ofstream outfile8 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_8_data.csv", ios::app);
ofstream outfile9 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_9_data.csv", ios::app);

ofstream outfile10 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_10_data.csv", ios::app);
ofstream outfile11 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_11_data.csv", ios::app);
ofstream outfile12 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_12_data.csv", ios::app);
ofstream outfile13 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_13_data.csv", ios::app);

ofstream outfile14 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_14_data.csv", ios::app);
ofstream outfile15 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_15_data.csv", ios::app);
ofstream outfile16 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_16_data.csv", ios::app);
ofstream outfile17 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_17_data.csv", ios::app);

ofstream outfile18 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_18_data.csv", ios::app);
ofstream outfile19 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_19_data.csv", ios::app);
ofstream outfile20 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_20_data.csv", ios::app);
ofstream outfile21 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_21_data.csv", ios::app);

ofstream outfile22 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_22_data.csv", ios::app);
ofstream outfile23 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_23_data.csv", ios::app);
ofstream outfile24 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_24_data.csv", ios::app);
ofstream outfile25 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_25_data.csv", ios::app);

ofstream outfile26 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_26_data.csv", ios::app);
ofstream outfile27 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_27_data.csv", ios::app);
ofstream outfile28 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_28_data.csv", ios::app);
ofstream outfile29 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_29_data.csv", ios::app);
ofstream outfile30 ("scratch/RLinWiFi-Decentralized-v14-30-station/history_30_data.csv", ios::app);*/
...
Ptr<OpenGymDataContainer> MyGetObservation()
{
        ...
        //std::cout << "MyGetObservation- history_length: " << history_length << std::endl;
...
void recordHistory()
{
    ...
    for (uint32_t sta_id = 0; sta_id < nWifi ; sta_id++)
    {
         ...
         float errs = sent_total - received_total;           // Errors (...)                        
         
         if(errs < 0){
             ratio_total = 0;
         } else {
             ratio_total = errs / sent_total; // calcula a pcol de cada Station
         }       
   ...
   for (uint32_t sta_id = 0; sta_id < nWifi ; sta_id++)
    {   
            history[sta_id].push_front(ratio_total);
        
            /*if(sta_id == 0 ){
                outfile1 <<  ratio_total << endl;
            }else if(sta_id == 1){
                outfile2 <<  ratio_total << endl;
            }else if (sta_id == 2 ){
                outfile3 <<  ratio_total << endl;
            }else if(sta_id == 3 ){
                outfile4 <<  ratio_total << endl;
            }else if(sta_id == 4 ){
                outfile5 <<  ratio_total << endl;
            }else if(sta_id == 5 ){
                outfile6 <<  ratio_total << endl;
            }else if(sta_id == 6 ){
                outfile7 <<  ratio_total << endl;
            }else if(sta_id == 7 ){
                outfile8 <<  ratio_total << endl;
            }else if(sta_id == 8 ){
                outfile9 <<  ratio_total << endl;
            }else if(sta_id == 9 ){
                outfile10 <<  ratio_total << endl;
            }else if(sta_id == 10 ){
                outfile11 <<  ratio_total << endl;
            }else if(sta_id == 11 ){
                outfile12 <<  ratio_total << endl;
            }else if(sta_id == 12 ){
                outfile13 <<  ratio_total << endl;
            }else if(sta_id == 13 ){
                outfile14 <<  ratio_total << endl;
            }else if(sta_id == 14 ){
                outfile15 <<  ratio_total << endl;
            }else if(sta_id == 15 ){
                outfile16 <<  ratio_total << endl;
            }else if(sta_id == 16 ){
                outfile17 <<  ratio_total << endl;
            }else if(sta_id == 17 ){
                outfile18 <<  ratio_total << endl;
            }else if(sta_id == 18 ){
                outfile19 <<  ratio_total << endl;
            }else if(sta_id == 19 ){
                outfile20 <<  ratio_total << endl;
            }else if(sta_id == 20 ){
                outfile21 <<  ratio_total << endl;
            }else if(sta_id == 21 ){
                outfile22 <<  ratio_total << endl;
            }else if(sta_id == 22 ){
                outfile23 <<  ratio_total << endl;
            }else if(sta_id == 23 ){
                outfile24 <<  ratio_total << endl;
            }else if(sta_id == 24 ){
                outfile25 <<  ratio_total << endl;
            }else if(sta_id == 25 ){
                outfile26 <<  ratio_total << endl;
            }else if(sta_id == 26 ){
                outfile27 <<  ratio_total << endl;
            }else if(sta_id == 27 ){
                outfile28 <<  ratio_total << endl;
            }else if(sta_id == 28 ){
                outfile29 <<  ratio_total << endl;
            }else{
                outfile30 <<  ratio_total << endl;
            }*/
        
        //std::cout << "recordHistory- history_length: " << history_length << std::endl;
        if (history[sta_id].size() > history_length)
         {
             history[sta_id].pop_back();
         }
...
int main(int argc, char *argv[])
{
    ...
    /*outfile1 << "Pcol-1" << endl;
    outfile2 << "Pcol-2" << endl;
    outfile3 << "Pcol-3" << endl;
    outfile4 << "Pcol-4" << endl;
    outfile5 << "Pcol-5" << endl;
    outfile6 << "Pcol-6" << endl;
    outfile7 << "Pcol-7" << endl;
    outfile8 << "Pcol-8" << endl;
    outfile9 << "Pcol-9" << endl;
    outfile10 << "Pcol-10" << endl;
    outfile11 << "Pcol-11" << endl;
    outfile12 << "Pcol-12" << endl;
    outfile13 << "Pcol-13" << endl;
    outfile14 << "Pcol-14" << endl;
    outfile15 << "Pcol-15" << endl;
    outfile16 << "Pcol-16" << endl;
    outfile17 << "Pcol-17" << endl;
    outfile18 << "Pcol-18" << endl;
    outfile19 << "Pcol-19" << endl;
    outfile20 << "Pcol-20" << endl;
    outfile21 << "Pcol-21" << endl;
    outfile22 << "Pcol-22" << endl;
    outfile23 << "Pcol-23" << endl;
    outfile24 << "Pcol-24" << endl;
    outfile25 << "Pcol-25" << endl;
    outfile26 << "Pcol-26" << endl;
    outfile27 << "Pcol-27" << endl;
    outfile28 << "Pcol-28" << endl;
    outfile29 << "Pcol-29" << endl;
    outfile30 << "Pcol-30" << endl;*/
